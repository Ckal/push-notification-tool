...
- URL: https://huggingface.co/spaces/Chris4K/push-notification-tool
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/push-notification-tool/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/push-notification-tool
